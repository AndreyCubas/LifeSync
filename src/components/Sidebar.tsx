...
export function Sidebar() {
  ...
  return (
    <aside
      className="
      w-56 shrink-0 flex flex-col justify-between py-5 px-3
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-center gap-2.5 px-2 mb-8">
          <div className="w-7 h-7 rounded-xl bg-linear-to-br from-indigo-500 to-violet-500 flex items-center justify-center shadow shadow-indigo-200">
        ...
        <div className="mt-4 px-1">
          ...
          >
            ...
            {/* Toggle pill */}
            <div
              className={`relative w-10 h-5 rounded-full transition-colors duration-300 ${dark ? "bg-indigo-600" : "bg-slate-200"}`}
            >
              <div
                className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform duration-300 ${dark ? "translate-x-5" : "translate-x-0.5"}`}
              />
            </div>
          </button>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-700">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-linear-to-br from-indigo-400 to-violet-400 flex items-center justify-center text-white text-xs font-bold shrink-0">
