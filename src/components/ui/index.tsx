...
export function CategoryBadge({ category }: { category: BlockCategory }) {
  const cfg = CATEGORY_CONFIG[category] ?? {
    tailwind: "bg-slate-100 text-slate-500 border-slate-200",
  };
  return (
    <span
      className={`inline-block text-[11px] font-semibold px-2.5 py-0.5 rounded-full border ${cfg.tailwind}`}
    >
      {category}
    </span>
  );
...
export function ProgressBar({
  ...
  return (
    <div
      className={`w-full bg-slate-100 rounded-full overflow-hidden ${height}`}
    >
      <div
...
export function Modal({
  ...
  return (
    ...
    >
      <div
        className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full ${width} max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-150`}
      >
...
export const FitnessIcon = () =>
  iconPath(
    <>
      <path d="M6.5 6.5h11" />
      <path d="M6.5 17.5h11" />
      <path d="M3 9.5h3.5v5H3z" />
      <path d="M17.5 9.5H21v5h-3.5z" />
    </>,
  );
...
export const AppleIcon = () =>
  iconPath(
    <>
      <path d="M12 20.94c1.5 0 2.75-.63 4-1.68 1.3 1 2.1 1.68 3.5 1.68 1 0 2-.37 2.5-1 .5-.62.77-1.4.77-2.12 0-.62-.13-1.22-.5-1.75C21.9 15.08 21 14.5 20 14.5c-.5 0-.88.12-1.25.37" />
      <path d="M17.5 9.5c0-3.04-2.46-5.5-5.5-5.5S6.5 6.46 6.5 9.5c0 1.54.63 2.92 1.64 3.92" />
    </>,
  );
